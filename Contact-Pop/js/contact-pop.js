...
ContactPop = {
    ...
    formPhpLocation : '/newsonmap/Contact-Pop/contact-pop.php', // relative path to the backend contact form
    
    pathToContactPop : '/newsonmap/Contact-Pop', // relative path to the Contact-Pop directory
    
    contactHeadline : 'We Value Your Feedback',
